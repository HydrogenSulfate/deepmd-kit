...
def enable_prim(enable: bool = True):
    ...
    if JIT:
        if enable:
            ...
            log.info(
                f"Add {STATIC_COMP_OP_BLACK_LIST} into static decomposite blacklist"
            )
    else:
        if enable:
            ...
            log.info(f"Add {EAGER_COMP_OP_BLACK_LIST} into eager decomposite blacklist")
