...
DP_VARIANT=cuda DP_ENABLE_TENSORFLOW=0 DP_ENABLE_PYTORCH=0 cmake \
	...
	${CUDA_ARGS} \
	-D PADDLE_INFERENCE_DIR=/home/Paddle/build/paddle_inference_install_dir/ \
...
export PATH=/home/deepmd-kit/source/build/_deps/lammps_download-src/src:$PATH
